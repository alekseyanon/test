...
describe Api::ObjectsController do
  ...
  describe "GET 'nearby'" do
    ...
    it 'returns objects nearby another' do
      ...
      ld1 = GeoObject.make! describable: l1, title: 1  # Наш технический долг касательно БД
      n2 = Osm::Node.make! geom: 'POINT(2 2)'
      l2 = Landmark.make! osm: n2
      ld2 = GeoObject.make! describable: l2, title: 2  # дает о себе знать даже здесь
      n3 = Osm::Node.make! geom: 'POINT(10 10)'
      l3 = Landmark.make! osm: n3
      ld3 = GeoObject.make! describable: l3, title: 3  # в тестах
      n4 = Osm::Node.make! geom: 'POINT(0 0)'
      l4 = Landmark.make! osm: n4
      ld4 = GeoObject.make! describable: l4, title: 4
