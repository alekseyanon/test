class Smorodina.Views.Comments extends Backbone.View
  ...
  events:
    ...
    'ajax:beforeSend .pic_comments__add.normal form'											: 'before_form_ajax'
    'ajax:complete .pic_comments__add.normal form'												: 'after_form_ajax'
  ...
  after_link_ajax: (evt, data, status, xhr)->
    ...
    @append_to.find('input[type=text]').focus()
