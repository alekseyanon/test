...
class AuthenticationsController < ApplicationController
  ...
  def create
    ...
    #TwitterAccount.new.post('test')
    #@graph = Koala::Facebook::API.new('AAABhYVst30oBACyXXXh4tiSoDZBjoaZCeXPwUiOSxR5CRzRpgNC9XUORPOU9CgVnEOZANpmHZAeZB7r6cvwicW6nAJewZBiFON9w7VrZAs0jgZDZD')
    #@graph.put_connections("me", "feed", :message => "It's test writing on my wall!")
    #logger.debug temp
